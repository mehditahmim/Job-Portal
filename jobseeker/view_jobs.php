...
<center><h3><br>Details of <?php echo $result['title']; ?> by <?php echo $res['ename']; ?> </h3></center>
<button class="btn btn-warning btn-lg" onclick="goBack()"><span class="glyphicon glyphicon-arrow-left"></span> Back </button>
         <button name="apply" type="submit" class="btn btn-success btn-lg" onclick="apply(<?php echo $result['jobid']; ?>)">
