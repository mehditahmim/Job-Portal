...
<div class="container" id="viewmain">
   ...
   // $query2=mysqli_query($db1,"select * from company where eid = '$result[eid]'");
...
<?php
} else  echo " <div class='container'> <div class='alert alert-warning alert-dismissible' role='alert'>
