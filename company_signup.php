...
<nav class="navbar" id="insidenav">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      <li class="active"><a href="jobseeker_signup.php">Employer Registration</a></li>
    </ul>
...
<form role="form" id="regcomp" onsubmit="return checkForm()" class="form-horizontal" method="post" action="company_registrationp.php">
